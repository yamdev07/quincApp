...
@section('title', 'Modifier un employé - ' . $tenant->company_name)
...
<div class="st-page">
    ...
    <div class="st-header">
        <div class="st-header-l">
            ...
            <div>
                ...
                <div class="st-sub">{{ $tenant->company_name }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="st-card">
        ...
        <div class="st-card-body">
            <form action="{{ route('super-admin.tenants.users.update', [$tenant, $user]) }}" method="POST">
                @csrf
                @method('PUT')
