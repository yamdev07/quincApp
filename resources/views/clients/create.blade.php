...
@section('title', 'Ajouter un client — Sellvantix')
...
<div class="sc-page">
    ...
    <div class="sc-header">
        <div class="sc-header-l">
            ...
            <div>
                <div class="sc-title">
                    Ajouter un <span>client</span>
                </div>
                <div class="sc-sub">Renseignez les informations du nouveau client</div>
            </div>
        </div>
    ...
    <div class="sc-preview">
        ...
        <div class="sc-preview-grid">
            ...
            <div class="sc-preview-item">
                ...
                <div class="sc-preview-value" id="preview-email">-</div>
            </div>
            <div class="sc-preview-item">
