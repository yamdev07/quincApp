            ...
            <div class="faq-grid">
                ...
                <div class="faq-column">
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            <p>Oui, Sellvantix s'intègre avec les principaux logiciels de comptabilité : <strong>QuickBooks, Sage, Cegid, et Dolibarr</strong>. Nous proposons également une API REST pour des intégrations personnalisées.</p>
                        </div>
                    </div>
                </div>
            </div>
