...
<head>
    ...
    <title>Bienvenue sur QuincaPro</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>🎉 Bienvenue sur QuincaPro !</h1>
        </div>
        
        <div class="content">
            <h2 style="margin-top:0;">Bonjour {{ $user->name }},</h2>
            
            <p>Votre quincaillerie <strong>{{ $user->tenant->company_name ?? 'QuincaPro' }}</strong> a été créée avec succès !</p>
            
            <p>Vous bénéficiez maintenant d'un essai gratuit de <strong>14 jours</strong> pour découvrir toutes les fonctionnalités de QuincaPro.</p>
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} QuincaPro. Tous droits réservés.</p>
