...
<html>
<head>
    <title>Confirmation de paiement - Sellvantix</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="margin-top: 20px;">Merci de votre confiance ! L'équipe Sellvantix reste à votre disposition.</p>
        </div>
        
        <div class="footer">
            <p>© {{ date('Y') }} Sellvantix. Tous droits réservés.</p>
