...
@section('title', 'Nouveau produit — Sellvantix')
    ...
    <div class="sp-create-card">
        ...
        <div class="sp-create-card-body">
            <form action="{{ route('admin.products.store') }}" method="POST" id="createProductForm">
                ...
                <div class="sp-create-form-group">
                    <label for="stock_alert" class="sp-create-label">
                        <svg viewBox="0 0 24 24" stroke-width="2" style="display:inline;">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                        </svg>
                        Seuil d'alerte stock
                    ...
                    <div class="sp-create-field-wrapper focus-scale">
                        ...
                        <input type="number"
                               ...
                               class="sp-create-input @error('stock_alert') error @enderror"
                               min="0"
                               placeholder="10">
                    </div>
                    <p style="font-size:11px; color:#94a3b8; margin-top:4px;">
                        Une alerte s'affiche quand le stock atteint ce seuil. Défaut : 10.
                    </p>
                    @error('stock_alert')
                        <p class="sp-create-error-message">{{ $message }}</p>
                    @enderror
                </div>
