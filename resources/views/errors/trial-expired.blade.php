                    ...
                    <div class="mt-auto pt-4">
                        <form action="{{ route('payment.callback') }}" method="POST">
                            ...
                            <script 
                                ...
                                data-transaction-description="Abonnement QuincaPro - Formule Mensuelle"
                    ...
                    <div class="mt-auto pt-4">
                        <form action="{{ route('payment.callback') }}" method="POST">
                            ...
                            <script 
                                ...
                                data-transaction-description="Abonnement QuincaPro - Formule Trimestrielle"
                                data-currency-iso="XOF"
                                data-customer-email="{{ Auth::user()->email }}"
                                data-customer-firstname="{{ explode(' ', Auth::user()->name)[0] ?? '' }}"
                                data-customer-lastname="{{ explode(' ', Auth::user()->name)[1] ?? '' }}">
                    ...
                    <div class="mt-auto pt-4">
                        <form action="{{ route('payment.callback') }}" method="POST">
                            ...
                            <script 
                                ...
                                data-transaction-description="Abonnement QuincaPro - Formule Semestrielle"
                                data-currency-iso="XOF"
                                data-customer-email="{{ Auth::user()->email }}"
                                data-customer-firstname="{{ explode(' ', Auth::user()->name)[0] ?? '' }}"
                                data-customer-lastname="{{ explode(' ', Auth::user()->name)[1] ?? '' }}">
                    ...
                    <div class="mt-auto pt-4">
                        <form action="{{ route('payment.callback') }}" method="POST">
                            ...
                            <script 
                                ...
                                data-transaction-description="Abonnement QuincaPro - Formule Annuelle"
                                data-currency-iso="XOF"
                                data-customer-email="{{ Auth::user()->email }}"
                                data-customer-firstname="{{ explode(' ', Auth::user()->name)[0] ?? '' }}"
                                data-customer-lastname="{{ explode(' ', Auth::user()->name)[1] ?? '' }}">
